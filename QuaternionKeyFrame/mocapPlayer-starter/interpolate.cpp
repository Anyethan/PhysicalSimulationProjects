...
int main(int argc, char **argv) 
{
  ...
  else if (interpolationTypeString[0] == 'n') {
	  interpolationType = Non_uniform;
  }
  else
  {
  ...
  std::cout << "computation time for " << interpolationTypeString << " " << angleRepresentationString << " is: " << (double)(end - start)<<std::endl;
