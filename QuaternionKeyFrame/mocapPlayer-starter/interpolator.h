...
{
  LINEAR = 0, BEZIER = 1, Non_uniform = 2
};
...
protected:
  ...
  vector lerp(vector start, vector end, double rate);
  ...
  //extra
  void NonUniform_BezierInterpolationQuaternion(Motion * pInputMotion, Motion * pOutputMotion);
